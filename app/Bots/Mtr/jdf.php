...
class jdf
{
    ...
    /*	F	*/
    static function jstrftime($format, $timestamp = '', $none = '', $time_zone = 'Asia/Tehran', $tr_num = 'fa')
    {
        ...
        for ($i = 0; $i < $sl; $i++) {
            ...
            switch ($sub) {
                ...
                case 'D':
                    $out .= substr($j_y, 2, 2) . 'jdf.php/' . (($j_m > 9) ? $j_m : '0' . $j_m) . '/' . (($j_d < 10) ? '0' . $j_d : $j_d);
                    break;
    ...
    /*	F	*/
    static function jmktime($h = '', $m = '', $s = '', $jm = '', $jd = '', $jy = '', $none = '', $timezone = 'Asia/Tehran')
    {
    ...
    /*	F	*/
    static function jgetdate($timestamp = '', $none = '', $timezone = 'Asia/Tehran', $tn = 'en')
    {
    ...
    /*	F	*/
    static function jcheckdate($jm, $jd, $jy)
    {
    ...
    /*	F	*/
    static function tr_num($str, $mod = 'en', $mf = '٫')
    {
    ...
    /*	F	*/
    static function jdate_words($array, $mod = '')
    {
